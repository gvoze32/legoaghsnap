...
copy_certificate() {
    ...
    cp -f "./.lego/certificates/_.${certFileName}.key" "/var/snap/adguard-home/current/${certFileName}.key"
    cp -f "./.lego/certificates/_.${certFileName}.crt" "/var/snap/adguard-home/current/${certFileName}.crt"
...
# TODO, add an interface and fix the output "domain" bug
